...
export const en = {
  translation: {
      ...
      planning: {
        eyebrow: "PLANNED CASH FLOW",
        title: "Planned cash flow",
        autoEntry: "Automatic entry",
        reminder: "Due reminder",
        hint: "Use automatic entries for fixed amounts, and reminders when an amount varies or needs confirmation.",
        automatic: "Automatic",
        paused: "Paused",
        recurringFallback: "Recurring entry",
        uncategorized: "Uncategorized",
        next: "Next {{date}}",
        disabled: "Disabled",
        monthlyDue: "Day {{day}} each month",
        editRecurring: "Edit recurring entry",
        resumeRecurring: "Resume recurring entry",
        pauseRecurring: "Pause recurring entry",
        deleteRecurring: "Delete recurring entry",
        editBill: "Edit reminder",
        disableBill: "Disable reminder",
        enableBill: "Enable reminder",
        deleteBill: "Delete reminder",
        emptyTitle: "No planned cash flow yet",
        emptyDetail: "Add automatic entries or due reminders to stay ahead of recurring income and expenses.",
        confirmDelete: "Delete this planned item?",
        loadFailed: "Could not load due reminders",
        previewFailed: "Could not load recurring previews",
        deleteFailed: "Could not delete the reminder",
        saveFailed: "Could not save the reminder",
        editReminder: "Edit due reminder",
        addReminder: "Add due reminder",
        name: "Name",
      ...
      goals: {
        ...
        emptyTitle: "Make room for what comes next",
        emptyDetail: "Set a travel, emergency, or other savings goal and track its progress here.",
        confirmDelete: "Delete this savings goal?",
        loadFailed: "Could not load savings goals",
        deleteFailed: "Could not delete the savings goal",
        saveFailed: "Could not save the savings goal",
        editTitle: "Edit savings goal",
        newTitle: "New savings goal",
        name: "Goal name",
        namePlaceholder: "For example: travel fund",
      ...
      ledgerSettings: {
        ...
        intro: "Classification rules run automatically during import and can also backfill existing transactions.",
        loadFailed: "Could not load classification rules",
        saved: "Rule saved",
        saveFailed: "Could not save the rule",
        confirmDelete: "Delete this rule?",
        deleteFailed: "Could not delete the rule",
        previewFailed: "Could not preview existing transactions",
        applied: "Applied to {{count}} transactions",
        applyFailed: "Could not apply the rule",
        disabled: "Disabled",
        descriptionContains: "Description contains “{{value}}”",
        allTransactions: "All transactions",
        categorySuffix: " · category {{value}}",
        payeeSuffix: " · payee {{value}}",
        preview: "Preview backfill",
        deleteRule: "Delete rule",
        confirmBackfill: "Confirm backfill: {{name}}",
        previewHelp: "Only transactions that would change are shown. Selected rows may update category, payee, or tags; amounts are never changed.",
        noChanges: "No existing transactions need changes.",
        noNote: "No note",
        originalCategory: "Original category",
        newCategory: "New category",
        applyCount: "Apply ({{count}})",
        newRule: "New classification rule",
        ruleName: "Rule name",
        ruleNamePlaceholder: "For example: classify Uber as transport",
        descriptionField: "Description contains",
        descriptionPlaceholder: "Uber",
        accountScope: "Account scope",
        allAccounts: "All accounts",
        transactionType: "Transaction type",
        anyType: "Any",
        applyCategory: "Apply category",
        noCategoryChange: "Do not change",
      ...
      users: {
        ...
        titleReset: "Reset password for “{{email}}”",
        email: "Email",
        emailPlaceholder: "e.g. alice@example.com",
        ...
        passwordReset: "Password for “{{email}}” reset",
        confirmDelete: "Delete user “{{email}}”? Their separate ledger data will also be deleted and cannot be recovered.",
        ...
        disabledFlash: "“{{email}}” disabled",
        enabledFlash: "“{{email}}” enabled",
        delete: "Delete user"
      },
      settings: {
